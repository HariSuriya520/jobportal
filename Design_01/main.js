...
const icons5 = document.querySelector(".icons5");
...
const icons6 = document.querySelector(".icons6");
...
const icons7 = document.querySelector(".icons7");
...
const icons8 = document.querySelector(".icons8");
...
const icons9 = document.querySelector(".icons9");
image9.onclick = function(){
	this.classList.toggle("active");
	icon9.classList.toggle("active");
}

const image10 = document.querySelector(".image10");
const icons10 = document.querySelector(".icons10");
image10.onclick = function(){
	this.classList.toggle("active");
	icon10.classList.toggle("active");
}

const image11 = document.querySelector(".image11");
const icons11 = document.querySelector(".icons11");
image11.onclick = function(){
	this.classList.toggle("active");
	icon11.classList.toggle("active");
}

const image12 = document.querySelector(".image12");
const icons12 = document.querySelector(".icons12");
image12.onclick = function(){
	this.classList.toggle("active");
	icon12.classList.toggle("active");
}

const image13 = document.querySelector(".image13");
const icons13 = document.querySelector(".icons13");
image13.onclick = function(){
	this.classList.toggle("active");
	icon13.classList.toggle("active");
}